...
let meatOrder = prompt('What kind of meat? (Separate meats with a comma if you would like more than one.)');
...
let condimentsOrder = prompt('What condiments would you like? (Separate multiple toppings with a comma.)');
...
let subtotal = prices.sandwich + meatCost + topppingCost + condimentCost;
